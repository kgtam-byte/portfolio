...
// ordinal scale that maps technology ids to colors
let colors = d3.scaleOrdinal(d3.schemeTableau10);

// read csv file + row converstion function
...
// display total lines of cide & commits 
function renderCommitInfo(data, commits) {
    ...
    dl.append('dd').text(longestLine + ' chars');
